package top.kgame.lib.ecstest.performance.isolated.parallelupdate.benchcomplex;
...
@ParallelUpdate
public class ComplexParallelBenchSystem extends EcsOneComponentUpdateSystem<ComponentPerfComplex> {
    @Override
