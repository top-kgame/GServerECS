...
@After(value = SystemDelayAddComponentCommandHolder.class)
public class SystemDefaultComponent1 extends EcsTwoComponentUpdateSystem<Component1, ComponentLexicographic> {

    @Override
    protected void update(EcsEntity entity, Component1 component, ComponentLexicographic lexicographic) {
